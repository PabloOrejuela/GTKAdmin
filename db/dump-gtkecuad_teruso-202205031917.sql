...
INSERT INTO `accesos` VALUES (1,'2022-04-01 20:34:06','976695','1648845546',2),(2,'2022-04-01 20:34:30','942291','1648845570',2),(3,'2022-04-01 20:40:46','191016','1648845946',2),(4,'2022-04-01 20:46:38','673063','1648846298',2),(5,'2022-04-03 02:28:22','123690','1648953202',2),(6,'2022-05-03 21:14:58','611748','1651612798',2),(7,'2022-05-03 21:16:23','920492','1651612883',2);
...
--
-- Table structure for table `bono_inicio`
--

DROP TABLE IF EXISTS `bono_inicio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bono_inicio` (
  `idbono` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `bono` decimal(10,2) unsigned NOT NULL DEFAULT 0.00,
  `patrocinador` int(10) unsigned NOT NULL,
  `pagado` tinyint(1) unsigned NOT NULL DEFAULT 0,
  `idcompras` int(10) unsigned NOT NULL,
  `last_updated` date NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`idbono`),
  KEY `fk_bono_compra` (`idcompras`),
  KEY `fk_bono_codigo` (`patrocinador`),
  CONSTRAINT `fk_bono_codigo` FOREIGN KEY (`patrocinador`) REFERENCES `codigo_socio` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_bono_compra` FOREIGN KEY (`idcompras`) REFERENCES `compras` (`idcompras`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `bono_inicio`
--

LOCK TABLES `bono_inicio` WRITE;
/*!40000 ALTER TABLE `bono_inicio` DISABLE KEYS */;
/*!40000 ALTER TABLE `bono_inicio` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `codigo_socio` VALUES (1,'CLTUN-0',0,'2022-03-23',1,8,'2022-05-03 21:10:14',1),(2,'ADMIN',1,'2022-04-01',2,1,'2022-05-03 23:38:59',1);
...
CREATE TABLE `compras` (
  ...
  `id` int(10) unsigned NOT NULL,
  `fecha` date NOT NULL,
  `primera` tinyint(1) unsigned NOT NULL DEFAULT 0,
...
INSERT INTO `cta_banco` VALUES (1,1,'0000000000',163,1),(2,2,'0000000000',163,1);
...
CREATE TABLE `membresia` (
  `idmembresia` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id` int(10) unsigned NOT NULL,
  `membresia` decimal(4,2) NOT NULL DEFAULT 0.00,
  `fecha` date DEFAULT NULL,
  `updated_at` date NOT NULL DEFAULT current_timestamp(),
  `pagado` tinyint(1) unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`idmembresia`),
  KEY `fk_membersia_codigo` (`id`),
  CONSTRAINT `fk_membersia_codigo` FOREIGN KEY (`id`) REFERENCES `codigo_socio` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `paquetes` (
  ...
  `pvp` decimal(6,2) unsigned NOT NULL,
...
INSERT INTO `paquetes` VALUES (1,1,30.00,30.00,1,0,12),(2,1,100.00,112.00,4,1,48),(3,1,300.00,336.00,12,4,144),(4,1,500.00,560.00,20,8,240),(5,1,1000.00,1120.00,40,20,480);
...
INSERT INTO `socios` VALUES (1,'CARLOS','LOPEZ','1802326643','ea105c6e1b00504c8d951a1f429fe92c','hostill@gmail.com',186,'AMBATO','0994093008',1,0,'2022-05-03 21:14:43'),(2,'ADMINISTRADOR','GTKECUADOR','1705520227','888abec6dc2926ee4b684274532750bb','pabloorejuela@hotmail.com',178,'VILLA FLORA','0993422997',1,0,'2022-05-03 23:09:45');
...
-- Dump completed on 2022-05-03 19:17:11
